...
function DrawerExample() {
  ...
  return (
    <div className="relative min-h-[28rem] overflow-hidden rounded-3xl bg-slate-100">
      ...
      <Drawer open={open} onClose={() => setOpen(false)} position="right">
        ...
        <DrawerItems>
          <p className="mb-4 text-sm text-slate-600">Use drawers for filters, secondary navigation, and side actions.</p>
